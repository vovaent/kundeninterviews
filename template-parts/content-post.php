		...
		<div class="ArticleBottomSocial">
			<div class="ArticleBottomSocialShare">
				...
				<div class="ArticleBottomSocialShareButtons">
					<a href="https://pinterest.com/pin/create/button/?url=<?php echo get_permalink(); ?>/<?php if(get_the_excerpt()){ echo('&description='.get_the_excerpt()); }?>" class="ArticleBottomSocialShareButtonsItem">
					...
					<a href="https://www.facebook.com/sharer?u=<?php echo get_permalink(); ?>;<?php if(get_the_excerpt()){ echo('&t='.get_the_excerpt()); }?>" class="ArticleBottomSocialShareButtonsItem">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<a href="http://twitter.com/intent/tweet<?php if(get_the_excerpt()){ echo('?text='.get_the_excerpt().';');}?>&url=<?php echo get_permalink(); ?>" class="ArticleBottomSocialShareButtonsItem">
